...
const { chains, provider } = configureChains(
  ...
  [alchemyProvider({ alchemyId: process.env.REACT_APP_ALCHEMY_KEY }), publicProvider()]
)
...
const Provider = ({ children }: { children: React.ReactNode }) => (
  <RainbowKitProvider chains={chains} theme={theme} appInfo={appInfo} showRecentTransactions={true}>
    {children}
  </RainbowKitProvider>
)
